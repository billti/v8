...
#define IS_TYPE_FUNCTION_DECL(Type, Value)               \
  V8_EXPORT_PRIVATE V8_INLINE bool Is##Type(const Isolate* isolate) const; \
  V8_EXPORT_PRIVATE V8_INLINE bool Is##Type(ReadOnlyRoots roots) const;    \
  V8_EXPORT_PRIVATE V8_INLINE bool Is##Type() const;
