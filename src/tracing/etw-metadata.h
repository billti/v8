...
#ifndef V8_TRACING_ETW_METADATA_H_
#define V8_TRACING_ETW_METADATA_H_

// This header needs to come first due to the following preprocess macro check
...
#endif  //  V8_TRACING_ETW_METADATA_H_
